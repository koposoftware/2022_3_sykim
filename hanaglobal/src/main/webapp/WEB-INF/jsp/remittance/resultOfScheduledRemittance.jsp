...
<div class="container" style="margin-left: 420px; margin-top: 50px;">
		...
		<h2 style="font-family: 'HanaB.ttf'; margin-left: 430px; margin-top:100px; display:inline-block">예약송금 상세조회</h2>
		...
		<form method="post" action="/resultOfRemittance" enctype="" style="margin-top: 50px">
			<table class="table ">
                ...
                <tr>
					...
					<th style="width: 270px; background-color: #f2f6f7">예약날짜</th>
					<td>${transactionList.targeteddate}</td>
				</tr>
				<tr>
					
					<th style="width: 270px; background-color: #f2f6f7">시간</th>
...
<!-- 				</tr> -->
				...
				<tr>
					<th style="background-color: #f2f6f7">수량</th>
					<td>$<fmt:formatNumber value="${transactionList.amount}" pattern="#,###"/></td>
				</tr>
...
<%-- 					<fmt:formatNumber value="${transactionList.finalamount}" pattern="#,###"/>원</td> --%>
<!-- 				</tr> -->
